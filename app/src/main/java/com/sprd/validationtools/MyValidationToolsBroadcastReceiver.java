...
public class MyValidationToolsBroadcastReceiver extends BroadcastReceiver {

    /* SPRD bug 843173:ZTE security code. */
    private static final String TAG = "MyValidationToolsBroadcastReceiver";
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if ("83789".equals(host)) {
            i.setClass(context, ChoseTestModeActivity.class);
            context.startActivity(i);
