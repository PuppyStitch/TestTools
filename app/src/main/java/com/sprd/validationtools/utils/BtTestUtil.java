...
public class BtTestUtil {
    ...
    public void startTest(Context context) {
        ...
        if(mBluetoothAdapter == null){
            Log.w(TAG, "startTest mBluetoothAdapter == null");
            return;
        }
        mContext = context;
        registerAllReceiver();
        Log.d(TAG, "startTest mBluetoothAdapter isEnabled="+ mBluetoothAdapter.isEnabled());
    ...
    public void stopTest() {
        /*SPRD bug 817253:Maybe cause NullPointerException.*/
        if(mBluetoothAdapter == null){
            Log.w(TAG, "stopTest mBluetoothAdapter == null");
            return;
        }
        Log.d(TAG, "stopTest mBluetoothAdapter isEnabled="+ mBluetoothAdapter.isEnabled());
    ...
    private void btStartDiscovery() {
        /*SPRD bug 817253:Maybe cause NullPointerException.*/
        if(mBluetoothAdapter == null){
            Log.w(TAG, "btPageScan mBluetoothAdapter == null");
            return;
        }
        if (mBluetoothAdapter != null) {
