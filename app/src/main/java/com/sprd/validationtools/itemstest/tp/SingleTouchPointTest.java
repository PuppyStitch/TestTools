...
public class SingleTouchPointTest extends BaseActivity {
    ...
    private static final String TAG = "SingleTouchPointTest";
    private static final int DISTANCE_XXDPI = 15;
    ...
    protected List<List<float[]>> getCirclesList() {
        /* SPRD bug 820104:Difficulty to draw single line */
        int textHeight = 0;
        if (mScreenHeight >= 1920 && mDisplayMetrics != null) {
            textHeight = (int) (DISTANCE_XXDPI * mDisplayMetrics.density);
            Log.d(TAG, "getCirclesList textHeight=" + textHeight);
            Log.d(TAG, "mDisplayMetrics.density=" + mDisplayMetrics.density);
        }
        float horizontalXY1[] = {
                DISTANCE,
                DISTANCE,
                mScreenWidth - DISTANCE,
                mScreenHeight - DISTANCE - textHeight
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.single_touch_test1);
        ...
        mNavigationBarHeight = getRealHeight(mContext) - getHeight(mContext);
    ...
    private float getRadiusPx() {
        ...
        if (mScreenHeight >= 1920) {
            ...
            radius = (RADIUS + DISTANCE_XXDPI) * mDisplayMetrics.density;
        }
        /* @} */
        return radius;
    }
    ...
    /**
     * @param x
     *            point x of touching screen
     * @param y
     *            point y of touching screen
     * @param list
     *            circle array
     * @param radius
     *            circle radius
